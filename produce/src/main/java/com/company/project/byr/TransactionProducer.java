 ...
 */
package com.company.project.byr;

import com.alibaba.fastjson.JSON;
import com.company.project.byr.entity.TransferRecord;
import com.company.project.byr.service.impl.TransactionListenerImpl;
...
public class TransactionProducer  implements InitializingBean {
    private static TransactionMQProducer producer = new TransactionMQProducer("group_name");
    @Autowired
